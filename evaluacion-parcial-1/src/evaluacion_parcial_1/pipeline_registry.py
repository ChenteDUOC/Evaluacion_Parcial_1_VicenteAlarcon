...
from evaluacion_parcial_1.pipelines import data_ingestion, data_cleaning, data_integration, data_validation
...
def register_pipelines() -> Dict[str, Pipeline]:
    ...
    return {
        ...
        "__default__": ingestion_pipeline + cleaning_pipeline + integration_pipeline + validation_pipeline,
    }